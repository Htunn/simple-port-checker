    ...
    async def _initialize_http(
        ...
        payload = {
            ...
            "params": {
                ...
                "clientInfo": {"name": "offensive-ai", "version": "2.0.0"},
            },
        }
        try:
